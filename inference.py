...
def main(args):
    ...
    테셋 꼬라지
        {
            "query": "Who is sitting in a chair in the background?",
            "outputs": "There is no person sitting in a chair in the background. ",
            "image": "10126247704_3bf0c7e05c_o.jpg",
            "json": "10126247704_3bf0c7e05c_o.json"
        }
    """
...
# O : {result}""")
        ...
        with open("/workspace/LISA/output_text/ours_candidate.txt", "w", encoding = "utf-8") as file:
            file.write(str(output_list))
        with open("/workspace/LISA/output_text/answer.txt", "w", encoding = "utf-8") as file:
